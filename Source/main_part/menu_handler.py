...
def print_people_and_drinks_out(Id_number,list_data,title,field_name1,field_name2):
    t = PrettyTable()
    t.title= title
    t.field_names =[field_name1,field_name2]
...
def output(answer):
    while True:
        if answer == 1:
            print_people_and_drinks_out(print_ID(people),print_people(),'People list','Person\'s ID','Person\'s name')
            return_to_input()
        elif answer ==2:
            print_people_and_drinks_out(print_ID(drinks),print_drinks(),'Drinks list','Drink\'s ID','Drink Name')
            return_to_input()
        elif answer == 3:
            exit()
        elif answer == 4:
